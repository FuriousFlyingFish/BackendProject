...
const Uhome = () => {
  ...
  return (
    <div style={{ backgroundColor: 'pink', minHeight: '100vh' }}>
      ...
      <br />
      <div>
        <h1 style={{ color: 'black' }}>Why use the GoCab app?</h1>
      ...
      <footer className="bg-gray-900 text-white py-6">
        <div className="container mx-auto flex justify-between">
          ...
          <div className="w-1/3">
            ...
            <p>
              🌐 Website: <a href="http://www.gocab.com" className="text-blue-400" target="_blank" rel="noopener noreferrer">www.ucab.com</a>
            </p>
